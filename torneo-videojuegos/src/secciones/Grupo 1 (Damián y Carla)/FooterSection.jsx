  ...
  const FooterSection = () => {
    return (
      ...
      <footer id='contacto' className='text-white flex flex-col items-center justify-start pt-[4vw] h-[20vw] text-center bg-white bg-gradient-to-b from-black from-10% via-[#001e1b] via-30% to-[#00c0ad] to-100%' >
